        ...
        <tr>
            ...
            <td>
                <form action="{{ route('post.kill', $hasil->id) }}" method="POST">
                    ...
                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusTrashPost{{ $hasil->id }}">Delete</button>
                    <div class="modal fade" tabindex="-1" role="dialog" id="hapusTrashPost{{ $hasil->id }}">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title">Hapus Trash Post</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body">
                              <p>Apakah anda yakin ingin menghapus permanen post {{ $hasil-> judul }}?</p>
                            </div>
